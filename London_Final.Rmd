...
```{r search_type, message=FALSE, warnings=FALSE}
london_df %>%
...
```{r gender, message=FALSE, warnings=FALSE}
london_df %>%
...
```{r age, message=FALSE, warnings=FALSE}
london_df %>%
...
```{r ethnicity, message=FALSE, warnings=FALSE}
london_df %>%
